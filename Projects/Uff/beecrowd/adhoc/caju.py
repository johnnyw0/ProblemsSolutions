...
def soma_lote(lin_final, lin_inicial, col_final, col_inicial):
    ...
    if sat[lin_inicial - 1][col_final] != 0:
        soma -= sat[lin_inicial - 1][col_final]
    if sat[lin_final][col_inicial -1] != 0:
        soma -= sat[lin_final][col_inicial - 1]
    if sat[lin_inicial - 1][col_final] != 0 and sat[lin_final][col_inicial -1] != 0:
